import 'package:aniqu_flutter/app/app_shell.dart';
import 'package:aniqu_flutter/core/constants/prefs_keys.dart';
import 'package:aniqu_flutter/core/storage/prefs_manager.dart';
...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  final ValueNotifier<VideoPlayerController?> _videoController = ValueNotifier<
      VideoPlayerController?>(null);

  int _loadingToken = 0;

  final List<OnboardingModel> _items = const [
    OnboardingModel(
      source: 'https://www.youtube.com/shorts/nAe82r8C9_4',
    ...
    OnboardingModel(
      source: 'https://www.youtube.com/shorts/8Lk-9a1WMNM',
    ...
    OnboardingModel(
      source: 'https://www.youtube.com/shorts/JXPb0FF1kS4',
